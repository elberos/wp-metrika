...
class Leads extends \Elberos\StructBuilder
{
	...
	public function init()
	{
		$this
			...
			->addField
			([
				"api_name" => "gmtime_lead_create",
				"label" => "Дата",
				"type" => "input",
				"column_value" => function ($struct, $item)
				{
					return \Elberos\wp_from_gmtime($item["gmtime_lead_create"]);
				},
			])
		;
	}
